return {
  ...
  -- Stole this look from Coding with Sphere video "11 Small but Useful Neovim Plugins"
    keys = {
      ...
      { "<C-A-j>", function() require("smart-splits").swap_buf_down() end, desc = "" },
      { "<C-A-k>", function() require("smart-splits").swap_buf_up() end, desc = "" },
      { "<C-A-l>", function() require("smart-splits").swap_buf_right() end, desc = ""},
      { "<C-A-h>", function() require("smart-splits").swap_buf_left() end, desc = ""},
    },
		opts = {
			ignored_buftypes = {
				"nofile",
